package com.hspliving.commodity.exception;

import com.hspliving.common.exception.HsplivingCodeEnum;
 ...
 *    表示统一接管 com.hspliving.commodity.controller包下抛出异常
 */
@Slf4j
@ResponseBody
@ControllerAdvice(basePackages = "com.hspliving.commodity.controller")
