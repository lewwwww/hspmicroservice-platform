...
public class TestController {
    ...
    public R testUpload() throws FileNotFoundException {
        ...
        // 密钥不写入代码库，请通过环境变量注入：ALICLOUD_ACCESS_KEY / ALICLOUD_SECRET_KEY
        String accessKeyId = System.getenv("ALICLOUD_ACCESS_KEY");
        String accessKeySecret = System.getenv("ALICLOUD_SECRET_KEY");
